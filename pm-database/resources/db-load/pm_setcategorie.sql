update betaling t set categorie = 'periodiek', status = 'gesloten' where lower(t.naam_tegenrekening) like '%odido%' or lower(t.naam_tegenrekening) like '%asr z%' or lower(t.naam_tegenrekening) like '%asr s%';

...
type BetalingsSoortSelectOrigineelProps = {
...
const BetalingsSoortSelectOrigineel = (props: BetalingsSoortSelectOrigineelProps) => {
...
export default BetalingsSoortSelectOrigineel;

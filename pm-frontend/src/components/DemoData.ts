...
export const aflossingen: AflossingDTO[] = [{
    ...
    notities: "Lorem ipsum odor amet, consectetuer adipiscing elit. Cursus ipsum natoque sodales vivamus est interdum. At facilisi tincidunt eget in suscipit suspendisse urna dui.",
    aflossingPeilDatum: dayjs(periode.periodeStartDatum).format('YYYY-MM-DD'),
    deltaStartPeriode: 1979,
    ...
    betaalDag: 6,
    dossierNummer: "Belastingdienst dossiernummer",
    notities: "Lorem ipsum odor amet, consectetuer adipiscing elit. Cursus ipsum natoque sodales vivamus est interdum. At facilisi tincidunt eget in suscipit suspendisse urna dui.",
    aflossingPeilDatum: dayjs(periode.periodeStartDatum).format('YYYY-MM-DD'),
    deltaStartPeriode: 111.4,
